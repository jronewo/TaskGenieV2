...
export const STRINGS: Record<Language, Record<string, string>> = {
  en: {
    ...
    "settings.error.badRequest": "Check the values you entered.",
    "settings.error.requestFailed": "Request failed ({status}).",
    "settings.error.generic": "Something went wrong. Please try again.",
    "settings.passwordChanged": "Password changed.",
    "settings.password": "Password",
    "settings.password.desc": "Changing it signs out your other devices.",
    "settings.password.current": "Current",
    "settings.password.new": "New",
    "settings.password.confirm": "Confirm",
    "settings.password.mismatch": "The two new passwords don't match.",
    "settings.password.change": "Change password",
    "settings.notifications.unread": "You have {count} unread notification(s).",
    "settings.notifications.caughtUp": "You're all caught up.",
    "settings.notifications.open": "Open notifications",
    "settings.theme.current": "Currently showing the {theme} theme.",
    "settings.session.desc": "Signing out revokes this device's refresh token on the server.",
    "settings.session.signOut": "Sign out",
    "profile.error.forbidden": "You don't have permission to perform this action.",
    "profile.error.requestFailed": "Request failed ({status}).",
    ...
    "profile.skillAdded": "Skill added to your profile.",
    "profile.removeSkillTitle": "Remove skill {name}?",
    "profile.removeSkillDesc": "This skill will no longer be used to suggest tasks for you.",
    ...
    "profile.mySkillsCount": "My skills ({count})",
    "profile.skillsDesc": "These drive the AI's assignment suggestions — the skill match factor is weighted 40%.",
    "profile.selectSkill": "Select a skill…",
    "profile.skillLevel": "Level {level}",
    "profile.noSkills": "No skills yet. Add a few so the AI can match you to the right tasks.",
    "profile.levelFor": "Level for {name}",
    "profile.removeSkill": "Remove {name}",
    "profile.projectHistoryCount": "Project history ({count})",
    "profile.noProjects": "You haven't worked on any project yet.",
    "profile.statusPlanning": "Planning",
    "profile.dueOn": " · due {date}",
    "profile.startedOn": " · started {date}",
    "profile.closedProjectsCount": "Finished projects ({count})",
    "profile.noClosedProjects": "No projects have been closed yet.",
    "profile.ended": "ENDED",
    "profile.personal": "Personal · ",
    "profile.closedOn": "closed {date}",
    "profile.popupBlocked": "The browser blocked the print window. Allow pop-ups for this page and try again.",
  ...
  vi: {
    ...
    "settings.error.badRequest": "Kiểm tra lại các giá trị đã nhập.",
    "settings.error.requestFailed": "Yêu cầu thất bại ({status}).",
    "settings.error.generic": "Đã có lỗi xảy ra. Vui lòng thử lại.",
    "settings.passwordChanged": "Đã đổi mật khẩu.",
    "settings.password": "Mật khẩu",
    "settings.password.desc": "Đổi mật khẩu sẽ đăng xuất các thiết bị khác.",
    "settings.password.current": "Hiện tại",
    "settings.password.new": "Mới",
    "settings.password.confirm": "Xác nhận",
    "settings.password.mismatch": "Hai mật khẩu mới không khớp.",
    "settings.password.change": "Đổi mật khẩu",
    "settings.notifications.unread": "Bạn có {count} thông báo chưa đọc.",
    "settings.notifications.caughtUp": "Bạn đã xem hết thông báo.",
    "settings.notifications.open": "Mở thông báo",
    "settings.theme.current": "Đang hiển thị giao diện {theme}.",
    "settings.session.desc": "Đăng xuất sẽ thu hồi refresh token của thiết bị này trên máy chủ.",
    "settings.session.signOut": "Đăng xuất",
    "profile.error.forbidden": "Bạn không có quyền thực hiện thao tác này.",
    "profile.error.requestFailed": "Yêu cầu thất bại ({status}).",
    "profile.error.generic": "Đã có lỗi xảy ra. Vui lòng thử lại.",
    "profile.updated": "Đã cập nhật hồ sơ.",
    "profile.avatarUpdated": "Đã cập nhật ảnh đại diện.",
    "profile.avatarChange": "Đổi ảnh đại diện",
    "profile.skillAdded": "Đã thêm kỹ năng vào hồ sơ.",
    "profile.removeSkillTitle": "Gỡ kỹ năng {name}?",
    "profile.removeSkillDesc": "Kỹ năng này sẽ không còn được dùng để gợi ý giao việc cho bạn.",
    "profile.remove": "Gỡ",
    "profile.fallback": "Hồ sơ",
    "profile.administrator": "Quản trị viên",
    "profile.member": "Thành viên",
    "profile.accountDetails": "Thông tin tài khoản",
    "profile.displayName": "Tên hiển thị",
    "profile.yourName": "Tên của bạn",
    "profile.role": "Vai trò",
    "profile.skillsCount": "Kỹ năng",
    "profile.projectsCount": "Dự án",
    "profile.mySkillsCount": "Kỹ năng của tôi ({count})",
    "profile.skillsDesc": "Các kỹ năng này giúp AI gợi ý giao việc cho bạn — trọng số khớp kỹ năng chiếm 40%.",
    "profile.selectSkill": "Chọn một kỹ năng…",
    "profile.skillLevel": "Cấp {level}",
    "profile.noSkills": "Chưa có kỹ năng nào. Thêm vài kỹ năng để AI gợi ý đúng việc cho bạn.",
    "profile.levelFor": "Cấp độ cho {name}",
    "profile.removeSkill": "Gỡ {name}",
    "profile.projectHistoryCount": "Lịch sử dự án ({count})",
    "profile.noProjects": "Bạn chưa tham gia dự án nào.",
    "profile.statusPlanning": "Đang lên kế hoạch",
    "profile.dueOn": " · hạn {date}",
    "profile.startedOn": " · bắt đầu {date}",
    "profile.closedProjectsCount": "Dự án đã xong ({count})",
    "profile.noClosedProjects": "Chưa có dự án nào được đóng.",
    "profile.ended": "ĐÃ KẾT THÚC",
    "profile.personal": "Cá nhân · ",
    "profile.closedOn": "đóng {date}",
    "profile.popupBlocked": "Trình duyệt đã chặn cửa sổ in. Cho phép pop-up cho trang này rồi thử lại.",
    "common.delete": "Xóa",
